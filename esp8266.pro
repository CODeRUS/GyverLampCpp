...
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/Adafruit BusIO"
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/Adafruit GFX Library"
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/ArduinoJson/src"
INCLUDEPATH += "$${HOMEDIR}/.platformio/packages/framework-arduinoespressif8266/libraries/DNSServer/src"
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/AsyncMqttClient/src"
...
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/ESPAsyncUDP/src"
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/ESPAsyncTCP/src"
...
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/FastLED"
...
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/Framebuffer GFX@src-253606634f60028dc274205c565fa224"
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/NTPClient"
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/arduinoFFT/src"
INCLUDEPATH += "$${PWD}/.pio/libdeps/nodemcu/ESPAsyncTCP@1.2.0/src"
