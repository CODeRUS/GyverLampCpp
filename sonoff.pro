...
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\arduinoFFT_ID1651\src"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\NTPClient_ID551"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\FastLED NeoMatrix"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\Framebuffer GFX"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\Adafruit GFX Library_ID13"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\FastLED_ID126"
...
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\ESPAsyncWiFiManager"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\ESP Async WebServer_ID306\src"
INCLUDEPATH += "$${HOMEDIR}\.platformio\packages\framework-arduinoespressif8266\libraries\Hash\src"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\ArduinoJson_ID64\src"
INCLUDEPATH += "$${HOMEDIR}\workplace\GyverLamp\firmware\GyverLampCpp\.pio\libdeps\sonoff\ESPAsyncTCP_ID305\src"
...
INCLUDEPATH += "$${HOMEDIR}\.platformio\packages\framework-arduinoespressif8266\tools\sdk\libc\xtensa-lx106-elf\include"
INCLUDEPATH += "$${HOMEDIR}\.platformio\packages\framework-arduinoespressif8266\cores\esp8266"
INCLUDEPATH += "$${HOMEDIR}\.platformio\packages\framework-arduinoespressif8266\tools\sdk\lwip2\include"
...
INCLUDEPATH += "$${HOMEDIR}\.platformio\packages\toolchain-xtensa\xtensa-lx106-elf\include\c++\4.8.2"
INCLUDEPATH += "$${HOMEDIR}\.platformio\packages\toolchain-xtensa\xtensa-lx106-elf\include\c++\4.8.2\xtensa-lx106-elf"
...
DEFINES += "F_CPU=160000000L"
DEFINES += "__ets__"
DEFINES += "ICACHE_FLASH"
DEFINES += "ARDUINO=10805"
DEFINES += "ARDUINO_BOARD=&quot;PLATFORMIO_ESP01_1M&quot;"
DEFINES += "FLASHMODE_DOUT"
...
SOURCES += src\GyverUdp.cpp
HEADERS += src\GyverUdp.h
...
SOURCES += src\effects\noise\CloudNoiseEffect.cpp
HEADERS += src\effects\noise\CloudNoiseEffect.h
SOURCES += src\effects\noise\ForestNoiseEffect.cpp
HEADERS += src\effects\noise\ForestNoiseEffect.h
SOURCES += src\effects\noise\LavaNoiseEffect.cpp
HEADERS += src\effects\noise\LavaNoiseEffect.h
SOURCES += src\effects\noise\MadnessNoiseEffect.cpp
HEADERS += src\effects\noise\MadnessNoiseEffect.h
SOURCES += src\effects\noise\NoiseEffect.cpp
HEADERS += src\effects\noise\NoiseEffect.h
SOURCES += src\effects\noise\OceanNoiseEffect.cpp
HEADERS += src\effects\noise\OceanNoiseEffect.h
SOURCES += src\effects\noise\PlasmaNoiseEffect.cpp
HEADERS += src\effects\noise\PlasmaNoiseEffect.h
SOURCES += src\effects\noise\RainbowNoiseEffect.cpp
HEADERS += src\effects\noise\RainbowNoiseEffect.h
SOURCES += src\effects\noise\RainbowStripeNoiseEffect.cpp
HEADERS += src\effects\noise\RainbowStripeNoiseEffect.h
