...
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/Adafruit BusIO"
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/Adafruit GFX Library"
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/ArduinoJson/src"
...
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/PubSubClient/src"
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/AsyncTCP/src"
...
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/FastLED"
...
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/Framebuffer GFX@src-253606634f60028dc274205c565fa224"
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/NTPClient"
INCLUDEPATH += "$${PWD}/.pio/libdeps/esp32dev/arduinoFFT/src"
